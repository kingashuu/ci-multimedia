  ...
  <div class="col-md-12">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">New Sub Classification</h3>
        ...
        <div class="row clearfix">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
              <?php echo form_open('sub_classification/add'); ?>
              <!-- <div class="col-xs-12 col-sm-12 col-md-12">
                <label for="Sub_Classification_Code" class="control-label"> <span class="text-danger"></span>Sub Classification Code</label>
                <div class="form-group">
                  <input type="text" name="Sub_Classification_Code" value="<?php echo $this->input->post('Sub_Classification_Code'); ?>" class="form-control " id="Sub_Classification_Code" />
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                  <input type="text" name="Sub_Classification_Name" value="<?php echo $this->input->post('Sub_Classification_Name'); ?>" class="form-control " id="Sub_Classification_Name" />
