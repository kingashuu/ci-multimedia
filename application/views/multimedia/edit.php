      ...
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <?php echo form_open_multipart('multimedia/edit/' . $multimedia['M_ID']); ?>
                <div class="col-sx-12 col-sm-6 col-md-6">
                  <label for="Code" class="control-label"> <span class="text-danger"></span>Code</label>
                  <div class="form-group">
                    <input type="text" name="Code" value="<?php echo $multimedia['Code']; ?>" class="form-control " id="Code" />
                ...
                <div class="col-sx-12 col-sm-6 col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="Name" value="<?php echo $multimedia['Name']; ?>" class="form-control " id="Name" />
                ...
                <div class="col-sx-12 col-sm-12 col-md-4">
                  <div class="row">
                    <div class="col-sx-12 col-sm-12 col-md-2">
                      <img width="50" height="50" src="<?php echo base_url('resource/Attachment/') . $multimedia['Attachment']; ?>">
                    </div>
                    <div class="col-sx-12 col-sm-12 col-md-10">
                      ...
                      <div class="form-group">
                        <input type="file" name="Attachment" value="<?php echo $multimedia['Attachment']; ?>" class="form-control " id="Attachment" />
                ...
                <div class="col-sx-12 col-sm-6 col-md-6">
                  ...
                  <div class="form-group">
                    <input type="date" name="Recorde_Date" value="<?php echo $multimedia['Recorde_Date']; ?>" class="has-datepicker form-control" data-date-format='YYYY-MM-DD' id="Recorde_Date" />
                ...
                <div class="col-sx-12 col-sm-6 col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="Recorde_By" value="<?php echo $multimedia['Recorde_By']; ?>" class="form-control " id="Recorde_By" />
                ...
                <div class="col-sx-12 col-sm-4 col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    echo form_dropdown('Language', $options, $multimedia['Language'],  'class="form-control"')
                    ?>
                    <span class="text-danger"><?php echo form_error('Sub_Classification'); ?></span>
                  </div>
                </div>
                <div class="col-sx-12 col-sm-4 col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    echo form_dropdown('Video_Type', $options, $multimedia['Video_Type'],  'class="form-control"')
                    ?>
                    <span class="text-danger"><?php echo form_error('Sub_Classification'); ?></span>
                  </div>
                </div>
                ...
                <div class="col-sx-12 col-sm-12 col-md-12">
                  ...
                  <div class="form-group">
                    <textarea name="Description" class="form-control   textarea" id="Description"><?php echo $multimedia['Description']; ?></textarea>
