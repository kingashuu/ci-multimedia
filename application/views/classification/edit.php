          ...
          <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
               ...
               <label for="Classification_Code" class="control-label">  <span class="text-danger"></span>Classification Code</label>
                <div class="form-group">
                  <input type="text" name="Classification_Code" value="<?php echo ($this->input->post('Classification_Code') ? $this->input->post('Classification_Code') : $classification['Classification_Code']); ?>" class="form-control" id="Classification_Code" />
